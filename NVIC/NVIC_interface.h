...
extern ErrorStatus NVIC_errEnableInterrupt(u8 In_u8Peripheral);

extern ErrorStatus NVIC_errDisableInterrupt(u8 In_u8Peripheral);

extern ErrorStatus NVIC_errSetPendingFlag(u8 In_u8Peripheral);

extern ErrorStatus NVIC_errClrPendingFlag(u8 In_u8Peripheral);

extern ErrorStatus NVIC_errSetPriority(u8 In_u8Peripheral, u8 In_u8Group, u8 In_u8SubGroup);

extern u8 NVIC_u8GetActiveFlag(u8 In_u8Peripheral);
